...
const Hero = () => {
  return (
    <div className="flex items-center relative  h-full justify-center ">
      {/* Top Hero button */}
      <div className="flex items-center w-[178px] h-[32px] md:w-[430px]  md:h-[48px]  ">
      ...
      <div className="w-[1104px.91px]  md:h-[372px] h-[250px] md:top-[148.79px] ">
        ...
        {/* Lines */}
         {/* <div className='w-[289px]  h-[354px] absolute top-[422px] right-[43px]'  >
            <img className="" src={Line2} alt="" />
         </div> */}

          {/* Image1 */}
          <div className="absolute w-[30px] h-[30px] md:w-[80px] md:h-[100px] top-[225.38px] md:top-[260.38px] lg:top-[264.38px] right-[265px] md:right-[470px]  lg:right-[700px] transform rotate-37.21">
            <img src={creditcard} alt="" />
          </div>

          {/* Image2 */}
          <div className="absolute w-[30px] h-[30px] md:w-[80px]  lg:w-[126px] md:h-[90.46px] top-[330.38px] md:top-[430.38px] lg:top-[500.38px] right-[235px] md:right-[410px] lg:right-[500px] transform rotate-37.21">
            <img src={Graduation} alt="" />
          </div>

          {/* Image3 */}
          <div className="absolute w-[30px] h-[30px] lg:w-[80px] md:h-[100px] top-[225.38px]  left-[-16px] md:left-[66px] lg:left-[240px] lg:top-[260.38px]  md:top-[260.38px]  transform rotate-37.21">
            <img src={profits} alt="" />
          </div>

          {/* Image4 */}
          <div className="absolute w-[25px] h-[30px] md:h-[90px] left-[-40px] top-[330.32px] sm:w-[60px] sm:h-[110px] md:w-[50px] md:left-[10px] lg:left-[120px] lg:top-[520px] md:top-[440px] lg:w-[80px] lg:h-[150px] transform rotate-37.21">
            <img src={Vector2} alt="Decorative Element" />
          </div>

          
          <div className="absolute flex flex-col items-center  w-[417.52px]  mt-[-105px] md:mt-0 lg:h-[80px] h-[10px]  md:w-[742px] md:h-[120px] top-[290px] md:left-[-580px]  left-[-328px] text-center">
            {/* Central h1 Text */}
            <div className="text-[18px]  md:text-[30px] lg:text-[48px]  font-semibold lg:leading-[59.52px]  md:leading-[38.52px] leading-[20.52px]   text-center">
              <h1>
                Cross-border{" "}
            ...
            <div className="w-[159px]  h-[27px] text-[7.6px] leading-[8.72px] my-6  md:w-[320px] md:h-[60px] md:text-[12px] md:leading-[19px] md:my-8  lg:w-[542px] lg:h-[90px] font-[400px] lg:text-[24px] lg:leading-[29.76px] lg:my-8  align-middle text-[#111827B2] ">
              <p>
            ...
            {/* Image */}
            <div className="w-[300px] h-[235px] ml-[55px] mt-[65px]  md:w-[500px] md:h-[320px] md:ml-[150px] md:mt-[40px]  lg:mt-[80px] lg:w-[960px] lg:h-[536px]  lg:ml-[260px] lg:left-[315px] ">
              <img src={hero} alt="/" />
            </div>
          </div>
        </div>
