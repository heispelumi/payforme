...
const About = () => {
  return (
    <div className="w-full pt-[50px] pb-[50px] lg:pt-[60px] flex flex-col bg-gray-100 mx-auto items-center">
    ...
    <h1 className="text-[15px] md:text-[30px]  lg:text-[35px] font-bold">Why We Built the Pay4me App</h1>
    <div className="flex flex-col md:gap-3 gap-2">
          <div className="md:h-[3px] h-[1px] w-[16px] md:w-[23px] rounded-[8px] rotate-[-40deg] bg-[#7AC52D]"></div>
          <div className="md:h-[3px] h-[1px] w-[16px] md:w-[23px] ml-[5px] bg-[#7AC52D]"></div>
          <div className="md:h-[3px] h-[1px] w-[16px] md:w-[23px] rounded-[8px] rotate-[40deg] bg-[#7AC52D]"></div>
        </div>
  </div>
