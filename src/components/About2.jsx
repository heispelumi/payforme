...
const About2 = () => {
  return (
    <div className="w-full h-full flex flex-col bg-white mx-auto lg:py-[150px]  items-center justify-center">
      {/* Title Section */}
      ...
      <div className="relative flex flex-row items-center pt-[10px] lg:pt-[60px] w-full">
        <div className="lg:w-[900px] w-[300px] px-[35px] md:px-[150px] lg:px-[200px] lg:h-[540px]">
          ...
          <div className="lg:w-[900px]  w-[350px] py-[40px] lg:py-[80px] space-y-[30px] lg:space-y-[60px] lg:h-[356px]"> 
            ...
            <div className="w-[4px] lg:w-[6px] h-[40px] lg:h-[50px] bg-brandPrimary"></div>
              <p className="w-[210px] text-[10px] md:w-[400px] lg:w-[896px] font-thin ml-3 lg:text-[26px]">
        ...
        <div className="absolute mt-[150px] md:mt-[-200px] lg:mr-[100px] lg:mt-0 bottom-[-1000x] lg:top-0 right-0 lg:right-[-100px] w-[160px] md:w-[300px] lg:w-[500px] h-full">
